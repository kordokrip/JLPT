...
export const CONTENT_PATHS = {
  ...
  n2Batch1:     path.join(REPO_ROOT, 'docs/05_n2/02_self_authored_batch_1.md'),
  n2Batch2:     path.join(REPO_ROOT, 'docs/05_n2/03_self_authored_batch_2.md'),
  n2Batch3:     path.join(REPO_ROOT, 'docs/05_n2/04_self_authored_batch_3.md'),
  n2Batch4:     path.join(REPO_ROOT, 'docs/05_n2/05_self_authored_batch_4.md'),
  n2Batch5:     path.join(REPO_ROOT, 'docs/05_n2/06_self_authored_batch_5.md'),
  n1Batch1:     path.join(REPO_ROOT, 'docs/06_n1/01_self_authored_batch_1.md'),
  n1Batch2:     path.join(REPO_ROOT, 'docs/06_n1/02_self_authored_batch_2.md'),
  n1Batch3:     path.join(REPO_ROOT, 'docs/06_n1/03_self_authored_batch_3.md'),
  n1Batch4:     path.join(REPO_ROOT, 'docs/06_n1/04_self_authored_batch_4.md'),
  ...
  topikOwnerBatch3: path.join(REPO_ROOT, 'docs/07_topik/04_owner_authored_grades_1_6_batch_3.md'),
  topikOwnerBatch4: path.join(REPO_ROOT, 'docs/07_topik/05_owner_authored_grades_1_6_batch_4.md'),
