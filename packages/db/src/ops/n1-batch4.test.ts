...
test('N1 Batch 4 adds self-authored academic argument, policy, and Google-only critical-reading practice', () => {
  ...
  assert.match(source, /Google 일본어 음성.*R2 발음 저장.*fallback은 사용하지 않/u);
