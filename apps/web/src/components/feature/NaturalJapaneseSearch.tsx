      ...
      <div className="mt-4 grid gap-3">
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex overflow-x-auto scrollbar-hide rounded-lg border-[0.5px] border-[var(--border)] bg-card p-1">
            {TONES.map((item) => (
              <button
                ...
                className={`min-h-11 whitespace-nowrap rounded px-3 font-pretendard text-sm transition-colors ${
                  tone === item
          ...
          <button
            ...
            className="min-h-11 rounded-lg bg-[var(--accent)] px-4 font-pretendard text-sm font-semibold text-white transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
          >
        ...
        <div className="mt-4 rounded-lg border-[0.5px] border-[var(--border)] bg-card p-4">
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              {result.alternatives.map((item) => (
                <button
                  ...
                  type="button"
                  onClick={() => onUse(item)}
                  className="min-h-11 rounded border border-[var(--border)] px-3 font-sans-jp text-sm text-foreground transition-colors hover:border-[var(--accent)] hover:text-[var(--accent)]"
                >
                  {item}
                </button>
              ))}
          ...
          <div className="mt-4 flex flex-col gap-2 sm:flex-row">
            <button
              ...
              className="min-h-11 flex-1 rounded-lg bg-[var(--accent)] px-4 font-pretendard text-sm font-semibold text-white transition-opacity hover:opacity-90"
            >
            ...
            <button
              ...
              className="min-h-11 flex-1 rounded-lg border-[0.5px] border-[var(--border)] px-4 font-pretendard text-sm font-medium text-foreground transition-colors hover:bg-[var(--surface-alt)]"
            >
