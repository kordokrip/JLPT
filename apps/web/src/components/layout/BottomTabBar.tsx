      ...
      {open && (
        <div className="fixed inset-0 z-40 bg-black/25 backdrop-blur-[2px] md:hidden" onClick={() => setOpen(false)}>
          <div
            ...
            className="absolute inset-x-3 bottom-[calc(var(--nav-height)+env(safe-area-inset-bottom)+0.75rem)] rounded-[var(--radius-xl)] border border-[var(--border)] bg-[var(--surface-glass)] p-3 shadow-[var(--shadow-float)] backdrop-blur"
