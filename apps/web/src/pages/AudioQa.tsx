      ...
      <section className="mb-6 rounded-lg border border-[var(--border)] bg-[var(--card)] p-5">
        <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <select
            ...
            className="h-[44px] min-h-[44px] rounded border border-[var(--border)] bg-[var(--card)] px-3 py-2 text-sm"
            aria-label="샘플 문장 선택"
          >
            ...
            <article key={provider.id} className="rounded-lg border border-[var(--border)] bg-[var(--card)] p-4">
              ...
              <div className="flex flex-wrap items-center gap-2">
                <button
                  ...
                  className="min-h-11 rounded-[var(--radius-md)] bg-[var(--accent)] px-4 text-sm font-medium text-white transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-40"
                >
                ...
                <button
                  ...
                  className={`min-h-11 rounded-[var(--radius-md)] border px-4 text-sm transition-colors ${
              ...
              <div className="mt-4 flex items-center gap-2">
                ...
                {[1, 2, 3, 4, 5].map((score) => (
                  <button
                    ...
                    className={`h-11 w-11 shrink-0 rounded-[var(--radius-md)] border text-sm font-medium ${
