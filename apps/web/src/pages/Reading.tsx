      ...
      <div className="flex gap-2 flex-wrap">
        {LEVELS.map(({ v }) => (
          <button
            ...
            type="button"
            onClick={() => setLevel(v)}
            className={`px-3 py-1.5 rounded-full border font-pretendard text-[13px] font-medium transition-colors ${
              level === v
      ...
      <div className="flex gap-2 flex-wrap">
        {GENRES.map(({ v, key, icon }) => (
          <button
            ...
            type="button"
            onClick={() => setGenre(v)}
            className={`flex items-center gap-1 px-3 py-1 rounded-full border font-pretendard text-[12px] transition-colors ${
              genre === v
