...
> **역사 문서:** 이 문서는 2026-05-28 당시의 문제 후보와 구현 기록이다. 현재 운영 기준은 `docs/PROJECT_ANALYSIS_2026.md`, `docs/ROADMAP.md`, `docs/00_overview/project-status-report.md`를 따른다. 특히 오디오는 승인된 R2 고정 파일을 우선하고 일본어 브라우저 음성은 명시적 fallback으로만 사용한다.
